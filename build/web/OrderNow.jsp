<%-- 
    Document   : OrderNow
    Created on : Aug 28, 2022, 6:24:28 PM
    Author     : count
--%>
...
.ChckContainer .checkmark:after {
  ...
  transform: rotate(45deg);
    ...
    <body>
        ...
        <div class="container">
            <div class="center">
    <form Name="DataForm" id="login" action="OrderServlet" method="post">
        
        <div class="txtfield">
            <input type="text" readonly="readonly" name="OrderID" value="Guest" class="DataForm__input"/>
            <span></span>
            
        </div>
        <div class="txtfield">
            <input type="text" readonly="readonly" name="CustomerID" value="Guest" class="DataForm__input"/>
            <span></span>
