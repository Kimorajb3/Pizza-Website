...
<head>
    ...
    <title>PizzaPlanet.com/Employee login page</title>
...
<div class="center">
    <form Name="DataForm" id="login" action="EmpServlet" method="post">
        <div class="txtfield">
            <!--Label for text box-->
            <input type="text" name="EmployeeID" class="DataForm__input" required/>
            <span></span>
