<%-- 
    ...
    Created on : Nov 29, 2022, 7:16:34 AM
    Author     : bellk
--%>
 ...
 <nav>
            <ul>
                ...
                <li><a href="CustOrderNow.jsp">Order Now</a></li>
                        ...
                        <li><a href="CustInfo.jsp">Customer Info</a></li>
    ...
    <!--Banner Image-->
        ...
        <h1 style="color:green;font-family:magneto;font-size:75px;">Order Updated!</h1>
        
        <div class="info">
               <a href="EmployeeInfo.jsp" class="hyper">Return to orders</a>
    </div>
    </body>
</html>
